...
from .. import __version__ as _lark_version
from . import lalr_argparser, build_lalr, make_warnings_comments
...
def gen_standalone(lark_inst, output=None, out=sys.stdout, compress=False):
    ...
    output('# The file was automatically generated by Lark v%s' % _lark_version)
    output('__version__ = "%s"' % _lark_version)
    output()
